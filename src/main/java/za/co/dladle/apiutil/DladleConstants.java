...
public class DladleConstants {
    ...
    public static final String TRANSACTION_VIEW = "Transactions retrieved Successfully";
    //------------------------------------------------------------------------------------------------------------------
    //Payments API
    //------------------------------------------------------------------------------------------------------------------
    ...
    public static final String SERVICE_STATUS = "Service Current Status Fetched";
